"""
Django settings for lifetime_love project.
...
SECRET_KEY = 'django-insecure-!o)*bgi-z=(_3x1unwl5m$p7c%%w_ysilsa$jr)(5s(br^y54d'
...
ROOT_URLCONF = 'lifetime_love.urls'
...
WSGI_APPLICATION = 'lifetime_love.wsgi.application'
